...
class ParseTargetTests(unittest.TestCase):
    def test_parses_issue_url(self) -> None:
        target = parse_github_target("https://github.com/acme/widgets/issues/17")
    ...
    def test_parses_pull_request_url(self) -> None:
        target = parse_github_target("https://github.com/acme/widgets/pulls/18")
    ...
    def test_rejects_non_github_urls(self) -> None:
        with self.assertRaises(ValueError):
            parse_github_target("https://example.com/acme/widgets/issues/17")
